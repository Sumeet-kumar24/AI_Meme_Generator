...
def CORS(app):
    """Enable the CORS headers needed by the frontend without extra dependencies."""
    @app.after_request
...
# Environment variables are provided by the hosting environment; avoid
# requiring python-dotenv at runtime.
...
# ═══════════════════════════════════════════════════════════════
#  Frontend served natively by Vercel edge via vercel.json
# ═══════════════════════════════════════════════════════════════
